          ...
          <div v-show="activeIndex === 5" class="accordion-content">
            <div className="flex">
                ...
                <div className="mt-2 ml-14 sm:mt-0">
                  <input type="text" className=" rounded-md w-96 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-200 placeholder:text-gray-200 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"/>
                </div>
            </div>
