    ...
    <div class="mt-[55rem] md:mt-0">
      <div class="md:ml-[30%] mr-[6%]">
        <div class="md:accordion ml-[10%] font-bold text-xl space-y-5">
            ...
            <div @click="toggleAccordion(1)" class="accordion-item">
              <div class="border-8 w-full rounded-md">
                <div class="accordion-title w-full flex bg-gray-200 gap-2">
                  <img src="images/passicon.png" class="w-8" />
                  Category & Passengers
                </div>
              </div>
            </div>
          ...
          <div>
            <div @click="toggleAccordion(2)" class="accordion-item">
              <div class="border-8 w-full rounded-md">
                <div class="accordion-title w-full flex bg-gray-200 gap-2">
                  <img src="images/Familyicon.png" class="w-8" />
                  Personal details
                </div>
              </div>
            </div>
          ...
          <div @click="toggleAccordion(3)" class="accordion-item">
            <div class="border-8 w-full rounded-md">
              <div class="accordion-title w-full flex bg-gray-200 gap-2">
                <img src="images/shopping.png" class="w-8" />
                Additional Services
              </div>
            </div>
          </div>
          ...
          <div @click="toggleAccordion(4)" class="accordion-item">
            <div class="border-8 w-full rounded-md">
              <div class="accordion-title w-full flex bg-gray-200 gap-2">
                <img src="images/icon.png" class="w-8" />
                Confirmation Details
              </div>
            </div>
          </div>
            ...
            <form  method="POST" action="/process_payment">
              ...
              <div class="h-screen ml-20">
                <div class="md:flex gap-[4rem] mb-4">
                  ...
                  <input type="text" id="card_number" name="card_number" class="form-input mt-1 w-full md:w-96">
                </div>
                <div class="md:flex gap-[6.8rem]">
                  <div>
                    <label for="expiry_month" class="font-medium text-gray-500">
                      Expiration Month
                    </label>
                  </div>
                  <div class="flex mb-4">
                    <input type="number" id="expiry_month" name="expiry_month"
                      class="form-input mt-1 w-full md:w-[42%]"><span class="mt-3 mx-1">/</span>
                    <input type="number" id="expiry_year" name="expiry_year" class="form-input mt-1 w-full md:w-[45%]">
                  </div>
                </div>
                <div class="md:flex gap-[6.8rem] mb-4">
                  ...
                  <input type="text" id="id_ssn_passport" name="id_ssn_passport" class="form-input mt-1 w-full md:w-96">
                </div>
                <div class="md:flex gap-[13.8rem] mb-4">
                  <label for="cvv" class="font-medium text-gray-500">
                    CVV
                  </label>
                  <input type="text" id="cvv" name="cvv" class="form-input mt-1 w-full md:w-96">
                </div>
                <div class="md:flex gap-[13.7rem] mb-4">
                  <label for="total_amount" class="font-medium text-gray-500">
                    Total
                  </label>
                  <input type="text" id="total_amount" name="total_amount" class="mt-1 w-full md:w-96"
                    placeholder="500.00">
                </div>
                <div>
                  <button type="submit"
                    class="bg-blue-500 items-center text-white ml-20 md:ml-80 mt-5 px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600">Pay
                    Now</button>
                </div>
              </div>
            </form>
