      ...
      <div class="md:ml-[30%] mr-[12%]">
        <div class="md:accordion ml-[10%] font-bold text-xl space-y-5">
          <div>
            ...
            <div v-show="activeIndex === 1" class="accordion-content">
              ...
              <div class="md:flex gap-64">
                ...
                <div>
                  <input class="rounded-full w-80" placeholder="How many passengers *" />
                </div>
              </div>
              <div class="item-end">
                <Link
          ...
          <div v-show="activeIndex === 4" class="accordion-content">
            ...
            <div
              class="left-2 md:top-20 md:left-20 flex justify-between md:mt-8 mt-5 p-3 border-b-4"
            ></div>
            ...
            <p
              class="mt-8"
            >•After your payment, the system will create a dedicated link for him so that he can enter and complete</p>
            <p
              class="ml-2"
            >the registration with the information and if he does not complete the registration in the next 72 hours,</p>
          ...
          <div v-show="activeIndex === 5" class="accordion-content">
            <div>
              ...
              <div class="flex">
                <Link
                  href="/custom-login"
                  class="flex rounded-full bg-[#014F99] w-50 md:w-60 p-2 mt-7 text-xs font-semibold justify-center text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >back</Link>
                <Link
                  href="/custom-payment"
                  class="flex rounded-full bg-[#014F99] w-60 p-2 mt-7 text-xs font-semibold ml-[80%] justify-center text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
