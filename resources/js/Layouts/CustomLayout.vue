        ...
        <div class="relative flex h-16 justify-between">
          ...
          <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-between">
            ...
            <div class="hidden sm:ml-6 sm:flex items-center sm:space-x-8">
              ...
              <a href="#" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-#2A2A2A hover:border-gray-300 hover:text-gray-700">Itinerary</a>
              <a href="#" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-#2A2A2A hover:border-gray-300 hover:text-gray-700">Hotel</a>
